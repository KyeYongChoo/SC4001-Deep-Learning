...
def hugging_face_connectivity_test():
	...
	cdn_https = check_host(
		"https://cdn-lfs.huggingface.co", name="cdn-lfs.huggingface.co"
	)

	# Step 3. try a real model file HEAD request
	print("\n--- Checking model file availability ---")
	head_req = check_host(
		"https://huggingface.co/timm/vit_base_patch16_224.augreg_in21k_ft_in1k/resolve/main/model.safetensors",
